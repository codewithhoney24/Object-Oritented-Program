...
class Administrator {
    ...
    constructor(name: string, employeeId: number, designation: string, salary: number, bonus: number, medicalFacility: string, leaves: number) {
        this.name = name;
...
async function addNewEmployee() {
    ...
    const newEmployee = new Administrator(
        answers.name,
        answers.employeeId,
        answers.designation,
        answers.salary,
        answers.bonus,
        answers.medicalFacility,
        answers.leaves
    );
